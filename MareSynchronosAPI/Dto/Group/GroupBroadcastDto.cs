...
public record GroupBroadcastDto(GroupData Group, UserData Owner, List<UserData> Broadcasters, ulong CurrentMemberCount, bool Passwordless, bool IsGuestModeEnabled)
{
